...
struct AnalysisSameEventPairing {
  ...
  void init(o2::framework::InitContext& context)
  {
    ...
    fEnableBarrelMixingHistos = context.mOptions.get<bool>("processMixingAllSkimmed") || context.mOptions.get<bool>("processMixingBarrelSkimmed") || context.mOptions.get<bool>("processMixingBarrelSkimmedFemto")|| context.mOptions.get<bool>("processMixingBarrelSkimmedFlow");
